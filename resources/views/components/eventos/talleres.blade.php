...
<div class="contenedorSubtituloTalleres subtituloTalleres"> Talleres </div>
    ...
    <div id="carouselTalleres" class="carousel slide carousel-fade">
        ...
        <div class="carousel-inner">
            ...
            <x-eventos.light-box_carousel diapositiva="slide-2" lugar="Second slide" statusCarouselItem="" imagen="{{ asset('img/image6.png') }}" titulo="Mejores prácticas para diseñar <br> interfaces móviles accesibles" texto="Los diseñadores y las empresas debemos descubrir las complejidades del diseño UX/UI móvil profundizando en una lista seleccionada de lo que se debe y no se debe hacer. Desde priorizar enfoques centrados en el usuario hasta evitar errores comunes, la lista busca ayudarte como diseñador o desarrollador." />
            <x-eventos.light-box_carousel diapositiva="slide-3" lugar="Third slide" statusCarouselItem="" imagen="{{ asset('img/image7.png') }}" titulo="Implementación de prácticas de <br>  diseño inclusivo" texto="Al implementar prácticas de diseño inclusivas, las empresas no sólo pueden cumplir con los requisitos legales y mejorar la experiencia del usuario, sino también acceder a nuevos mercados, mejorar su imagen de marca y fomentar la innovación." />
            <x-eventos.light-box_carousel diapositiva="slide-4" lugar="Fourth slide" statusCarouselItem="" imagen="{{ asset('img/image8.png') }}" titulo="Pruebas de usabilidad para entornos <br> virtuales" texto="Las pruebas de usabilidad son una técnica de evaluación en la que los usuarios interactúan con un producto, sistema o sitio web y se observa su comportamiento. Se utilizan para identificar problemas de usabilidad y mejorar la experiencia del usuario." />
        </div>
